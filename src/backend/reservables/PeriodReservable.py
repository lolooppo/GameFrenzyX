...
class PeriodReservable(Reservable):
    """Period-based reservations (e.g., football fields) - hourly time slot pricing"""
    
    def __init__(self, type, name, morning_hourly_rate, night_hourly_rate):
        super().__init__(type, name)
        self.periods = [0]*24  # 24-hour availability array
